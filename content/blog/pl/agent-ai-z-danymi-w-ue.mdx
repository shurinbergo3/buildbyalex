...
Przy integracji z systemem sprzedażowym pilnuję, żeby dane osobowe zostawały w CRM, a do modelu szedł tylko kontekst potrzebny do odpowiedzi. Jak to wygląda technicznie, opisałem w tekście o [połączeniu agenta AI z CRM](/pl/blog/integracja-agenta-ai-z-crm). W hotelarstwie ten sam wzorzec dotyczy danych rezerwacyjnych, o czym pisałem przy okazji agenta dla hotelu i apartamentów.
