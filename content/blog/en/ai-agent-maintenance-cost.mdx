...
It needs processing inside the EEA and a data processing agreement, not a server in any specific country. Practically: EU-region hosting, a model endpoint with EU processing, and a retention policy for conversation logs. More on that in where an AI chatbot stores customer data.
