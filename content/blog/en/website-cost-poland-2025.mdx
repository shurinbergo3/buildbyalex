...
ogImage: "/og/website-cost-2025-en.webp"
---
...
Three things: scope (how many pages and features), complexity (a static site vs. logic with a cart and auth), and who builds it (a student, a freelancer, an agency). The same "5 pages" can cost €800 or €8,000 — the difference is in design, SEO and code quality.
...
**How much do hosting and a domain cost per year?**
A `.pl` domain — €15–60/year. Hosting — from €0 (Vercel/Netlify for Next.js/Astro sites) up to €25/month for WordPress on a decent server. For a typical company site you'll realistically stay within €50–200 a year.

**Freelancer or agency — which is better?**
Freelancer: cheaper (€1,500–5,000), faster, direct contact — but the risk they vanish. Agency: pricier (€5,000–25,000), process and a team — but you also pay for an office and an account manager. For a company site, a senior freelancer usually wins on price-to-quality.
