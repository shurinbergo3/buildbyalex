...
**Where do I start on a minimal budget?**
With ChatGPT or Claude Pro at €20/mo for staff, plus simple automation of one process from €600. Don't start with a big custom agent.

**Will the AI make up answers?**
In a properly built RAG, almost never. You set a strict mode: no answer in the base → "I don't know" → hand off to a human.

**How long until the first result?**
An MVP on one task is 4–6 weeks. The first measurable saving usually lands within the first month of operation.

**Do I have to lay people off after implementing it?**
