...
A basic sales agent with one channel and one CRM — two to four weeks. Then a week or two tuning the script against live conversations.
...
**Which CRM can it connect to?**
Any with an API: AmoCRM, HubSpot, Pipedrive, Bitrix24, Salesforce. If the CRM has an API, integration is possible.

**What if my lead volume is low?**
Under 50 a month it usually doesn't pay back, and I'll say so. Run the process by hand first, then automate.
