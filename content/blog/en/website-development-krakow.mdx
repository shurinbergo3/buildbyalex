...
## Real-world case: a medical-tourism dental clinic in Kraków

Kraków doesn't only draw people for Wawel - they fly in to fix their teeth, because the prices are a fraction of Germany or Britain and the quality holds up. A clinic in exactly that segment came to me with the classic problem. The site was Polish and English, the English machine-made, and the patients were coming mostly from Germany, Britain, and the local Ukrainian community. A foreigner would land, see generic phrases and no prices, have no idea what a turnkey implant would actually cost, and leave for a competitor who laid out the price and the process like a human being. On top of that the site was slow, and the only way to get in touch was a form that dropped silently to email and sometimes got lost.

What I built: a new Next.js site, static, fast on mobile, with LCP around a second. Four language versions on separate URLs with hreflang - PL, EN, DE, UA - properly translated, forms and confirmation emails included, not run through an auto-plugin. A dedicated landing page for each key search, with a plain description of the procedure, a price guide in euros, how long the trip takes, and answers to the things a foreign patient actually worries about: guarantees, how many visits, how the logistics work. Inquiries were set to copy straight to the coordinator's messenger - a patient writing in the evening from another time zone needs a quick reply.

First three months: inquiries from foreign patients were up about 50%, and their quality rose too - people arrived already understanding the price and the process, so the coordinator wasn't explaining the basics from zero every time. The German version, which effectively hadn't existed before, brought its own stream of patients. The fast load helped in search as well: on English-language queries the site climbed noticeably. The project came in at six weeks, most of that spent on the procedure copy and having the translations proofed by native speakers.

Same lesson as the tourism side: if your customer is a foreigner, the site has to speak their language, show the price, and load instantly, or they go to whoever already does that.
