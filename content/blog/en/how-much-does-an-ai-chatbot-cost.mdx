...
**How does a chatbot differ from an AI agent in price?**
A chatbot answers — from €1200. An agent acts (CRM, calendar, payments) — from €2000. The price gap is in the number of integrations and error handling, not the model's "intelligence."

**What does the API actually cost per month?**
On cheap models (GPT-4o-mini, Gemini Flash), €30–80 at 1000+ conversations. On expensive ones (GPT-4o, Claude Sonnet), €100–400. The exact figure depends on conversation length and knowledge-base size.

**Can it be done for €1200?**
Yes — a focused single-task bot, one channel, a ready FAQ base. Anything beyond that (CRM, multiple channels, multilingual) moves the price up.

**Isn't a ready platform subscription cheaper?**
At launch, yes. Over a year, often not: €200–500/month subscription versus €50–100/month API plus your own code. And you can't leave the platform without a rebuild.
