...
**Is n8n really free?**
The Community Edition is — the license allows free use, including in business. You only pay for the server (a €5–10/mo VPS). There's also a paid n8n Cloud if you'd rather not deal with a server.

**Is Make really a third of Zapier's cost?**
On comparable load, usually yes, because operations are cheaper than tasks. But after Make's move to credits (August 2025), price your actual scenario — especially if you use AI modules.

**Can I start on Zapier and migrate later?**
Yes, and it's a normal path. Logic is moved by hand — there's no "one-click" migration — but for clear scenarios it's a day or two of work.

**Which is best for AI agents?**
n8n — it has the best support for LLM nodes, tools and agentic patterns out of the box. Make can do AI modules but they cost more in credits. Zapier is the weakest of the three for agents.
