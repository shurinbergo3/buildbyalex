        ...
        <Container>
          {key === "visionair" ? (
            ...
            <div className="relative overflow-hidden rounded-[26px] bg-[#070a08] px-6 py-12 shadow-[0_40px_120px_-44px_rgba(0,0,0,0.7),inset_0_0_0_1px_rgba(255,255,255,0.05)] sm:rounded-[36px] sm:px-10 sm:py-14 md:px-14 md:py-16">
              ...
              />
              {/* Apple-logo contours — outlined "яблоки" scattered across the dark stage,
                  lime-tinted near the aurora, fading toward the edges. iOS-native cue. */}
              <div aria-hidden="true" className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
                {/* large outline, upper area — peeks out beside the phone */}
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="#C8FF00"
                  strokeWidth="0.5"
                  className="absolute right-[34%] -top-2 h-44 w-44 opacity-[0.28] sm:h-52 sm:w-52 md:h-64 md:w-64"
                >
                ...
                {/* medium outline, bottom-left, cool white */}
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="#ffffff"
                  strokeWidth="0.55"
                  className="absolute -bottom-7 -left-7 h-36 w-36 opacity-[0.14] sm:h-44 sm:w-44 md:h-52 md:w-52"
                >
                  <path d="M16.36 12.79c-.02-2.13 1.74-3.15 1.82-3.2-0.99-1.45-2.53-1.65-3.08-1.67-1.31-.13-2.56.77-3.22.77-.66 0-1.69-.75-2.78-.73-1.43.02-2.75.83-3.48 2.11-1.48 2.57-.38 6.37 1.07 8.45.71 1.02 1.55 2.16 2.66 2.12 1.07-.04 1.47-.69 2.76-.69 1.29 0 1.65.69 2.78.67 1.15-.02 1.87-1.04 2.57-2.06.81-1.18 1.14-2.32 1.16-2.38-.03-.01-2.23-.86-2.26-3.39zM14.23 6.31c.58-.71.98-1.69.87-2.67-.84.03-1.86.56-2.47 1.26-.54.62-1.02 1.62-.89 2.58.94.07 1.9-.47 2.49-1.17z" />
                </svg>
                {/* small outline, mid-left accent */}
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="#C8FF00"
                  strokeWidth="0.65"
                  className="absolute left-[5%] top-[30%] hidden h-16 w-16 opacity-[0.16] sm:block md:h-20 md:w-20"
                >
                  <path d="M16.36 12.79c-.02-2.13 1.74-3.15 1.82-3.2-0.99-1.45-2.53-1.65-3.08-1.67-1.31-.13-2.56.77-3.22.77-.66 0-1.69-.75-2.78-.73-1.43.02-2.75.83-3.48 2.11-1.48 2.57-.38 6.37 1.07 8.45.71 1.02 1.55 2.16 2.66 2.12 1.07-.04 1.47-.69 2.76-.69 1.29 0 1.65.69 2.78.67 1.15-.02 1.87-1.04 2.57-2.06.81-1.18 1.14-2.32 1.16-2.38-.03-.01-2.23-.86-2.26-3.39zM14.23 6.31c.58-.71.98-1.69.87-2.67-.84.03-1.86.56-2.47 1.26-.54.62-1.02 1.62-.89 2.58.94.07 1.9-.47 2.49-1.17z" />
                </svg>
              </div>
