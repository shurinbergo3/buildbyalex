...
export const clusterToService: Record<string, { menuKey: ServiceMenuKey; path: ServicePath }> = {
  ...
  // 2026-08 backfill: base clusters whose posts shipped without a service mapping
  // (locale-suffixed variants only, or a later batch that skipped this table).
  // Unmapped posts render no offer link, so every live cluster belongs here.
  "ai-agent-customer-support": { menuKey: "ai", path: "/services/ai-agents" },
  "ai-chatbot-ecommerce": { menuKey: "ai", path: "/services/ai-agents" },
  "ai-agent-running-costs": { menuKey: "ai", path: "/services/ai-agents" },
  "ai-agent-vs-subscription": { menuKey: "ai", path: "/services/ai-agents" },
  "ai-assistant-for-business-cost": { menuKey: "ai", path: "/services/ai-agents" },
  "voicebot-cost": { menuKey: "ai", path: "/services/ai-agents" },
  "hiring-ai-agent-developer": { menuKey: "ai", path: "/services/ai-agents" },
  "cost-to-hire-ai-developers": { menuKey: "ai", path: "/services/ai-agents" },
  "choosing-ai-model-for-business": { menuKey: "ai", path: "/services/ai-agents" },
  "ai-automation-agency-services": { menuKey: "ai", path: "/services/ai-agents" },
  "ai-chatbot-medical-practice": { menuKey: "ai", path: "/services/ai-agents" },
  "ai-manufacturing-implementation": { menuKey: "ai", path: "/services/ai-agents" },
  "ai-receptionist-service-business": { menuKey: "ai", path: "/services/ai-agents" },
  "hire-n8n-developer": { menuKey: "automation", path: "/services/automation" },
  "auto-lodz": { menuKey: "automation", path: "/services/automation" },
  "web-czestochowa": { menuKey: "websites", path: "/services/websites" },
  "seo-audit-cost": { menuKey: "websites", path: "/services/websites" },
  "booking-website-cost": { menuKey: "websites", path: "/services/websites" },
  "web-app-for-business-cost": { menuKey: "websites", path: "/services/websites" },
  "website-construction-company": { menuKey: "websites", path: "/services/websites" },
  "website-training-company": { menuKey: "websites", path: "/services/websites" },
  "website-transport-company": { menuKey: "websites", path: "/services/websites" },
  "wordpress-website-cost": { menuKey: "websites", path: "/services/websites" },
  "store-gdynia": { menuKey: "store", path: "/services/online-store" },
  "store-szczecin": { menuKey: "store", path: "/services/online-store" },
  "shopify-developer-poland": { menuKey: "store", path: "/services/online-store" },
  "ecommerce-erp-integration": { menuKey: "store", path: "/services/online-store" },
  "website-with-shop-cost": { menuKey: "store", path: "/services/online-store" },
  "woocommerce-store-cost": { menuKey: "store", path: "/services/online-store" },
  "mobile-bialystok": { menuKey: "mobile", path: "/services/mobile-apps" },
  "mobile-lublin": { menuKey: "mobile", path: "/services/mobile-apps" },
  "mvp-app-development-startup": { menuKey: "mobile", path: "/services/mobile-apps" },
  "tg-torun": { menuKey: "telegram", path: "/services/telegram-bots" },
  "google-ads-agency-pricing": { menuKey: "ads", path: "/services/advertising" },
  // 2026-09 wave: AI implementation, EU deadlines and the fixed-price offers.
  // Informational topics, one cluster shared across locales (hreflang translations).
  "ai-act-bot-disclosure-tech": { menuKey: "ai", path: "/services/ai-agents" },
  "poland-ai-act-kribsi": { menuKey: "ai", path: "/services/ai-agents" },
  "e-doreczenia-business-2026": { menuKey: "automation", path: "/services/automation" },
  "ksef-service-company-crm": { menuKey: "automation", path: "/services/automation" },
  "ai-order-intake-wholesale": { menuKey: "ai", path: "/services/ai-agents" },
  "ai-accounting-office": { menuKey: "automation", path: "/services/automation" },
  "ai-agent-permissions": { menuKey: "ai", path: "/services/ai-agents" },
  "ai-agent-audit-repair": { menuKey: "ai", path: "/services/ai-agents" },
  "ai-pilot-30-days": { menuKey: "ai", path: "/services/ai-agents" },
  "ai-projects-fail-reasons": { menuKey: "ai", path: "/services/ai-agents" },
  "agent-or-workflow": { menuKey: "automation", path: "/services/automation" },
  "prompt-injection-business": { menuKey: "ai", path: "/services/ai-agents" },
  "ai-data-in-eu": { menuKey: "ai", path: "/services/ai-agents" },
  "ai-agent-testing-monitoring": { menuKey: "ai", path: "/services/ai-agents" },
  "custom-gpt-limits": { menuKey: "ai", path: "/services/ai-agents" },
  "ai-act-staff-training": { menuKey: "ai", path: "/services/ai-agents" },
  "ai-crawlers-javascript": { menuKey: "websites", path: "/services/websites" },
  "directories-reviews-ai": { menuKey: "websites", path: "/services/websites" },
  "product-feed-for-ai": { menuKey: "store", path: "/services/online-store" },
  "ai-project-takeover": { menuKey: "ai", path: "/services/ai-agents" },
  "it-department-questions": { menuKey: "ai", path: "/services/ai-agents" },
  "ai-quotes-differ": { menuKey: "ai", path: "/services/ai-agents" },
  "ai-property-management": { menuKey: "ai", path: "/services/ai-agents" },
  "ai-freight-dispatch": { menuKey: "ai", path: "/services/ai-agents" },
  "baselinker-automation": { menuKey: "store", path: "/services/online-store" },
};
