...
export const clusterToService: Record<string, { menuKey: ServiceMenuKey; path: ServicePath }> = {
  ...
  "web-poznan-pl": { menuKey: "websites", path: "/services/websites" },
  "web-poznan-en": { menuKey: "websites", path: "/services/websites" },
  "web-poznan-ru": { menuKey: "websites", path: "/services/websites" },
  "web-poznan-ua": { menuKey: "websites", path: "/services/websites" },
  "store-lodz-pl": { menuKey: "store", path: "/services/online-store" },
  "store-lodz-en": { menuKey: "store", path: "/services/online-store" },
  "store-lodz-ru": { menuKey: "store", path: "/services/online-store" },
  "store-lodz-ua": { menuKey: "store", path: "/services/online-store" },
  "mobile-szczecin-pl": { menuKey: "mobile", path: "/services/mobile-apps" },
  "mobile-szczecin-en": { menuKey: "mobile", path: "/services/mobile-apps" },
  "mobile-szczecin-ru": { menuKey: "mobile", path: "/services/mobile-apps" },
  "mobile-szczecin-ua": { menuKey: "mobile", path: "/services/mobile-apps" },
  "ai-lublin-pl": { menuKey: "ai", path: "/services/ai-agents" },
  "ai-lublin-en": { menuKey: "ai", path: "/services/ai-agents" },
  "ai-lublin-ru": { menuKey: "ai", path: "/services/ai-agents" },
  "ai-lublin-ua": { menuKey: "ai", path: "/services/ai-agents" },
  "web-katowice-pl": { menuKey: "websites", path: "/services/websites" },
  "web-katowice-en": { menuKey: "websites", path: "/services/websites" },
  "web-katowice-ru": { menuKey: "websites", path: "/services/websites" },
  "web-katowice-ua": { menuKey: "websites", path: "/services/websites" },
  ...
  "auto-rzeszow-pl": { menuKey: "automation", path: "/services/automation" },
  "auto-rzeszow-en": { menuKey: "automation", path: "/services/automation" },
  "auto-rzeszow-ru": { menuKey: "automation", path: "/services/automation" },
  "auto-rzeszow-ua": { menuKey: "automation", path: "/services/automation" },
