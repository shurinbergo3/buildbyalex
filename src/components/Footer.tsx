        ...
        <div className="grid grid-cols-2 gap-y-12 md:grid-cols-12 md:gap-y-0">
          ...
          <div className="col-span-2 md:col-span-3">
            ...
            <ul className="space-y-2.5 text-[14px] text-[color:var(--color-text-2)]">
              ...
              <li><a href="https://github.com/buildbyalex" target="_blank" rel="noreferrer noopener" className="hover:text-[color:var(--color-text)] transition-colors">{t("links.github")}</a></li>
              <li><a href="https://t.me/buildbyalex" target="_blank" rel="noreferrer noopener" className="hover:text-[color:var(--color-text)] transition-colors">{t("links.telegram")}</a></li>
            </ul>
          </div>
        </div>
